...
class Trustdart {
  ...
  /// Returns the hex string format of the public key.
  static Future<Uint8List> getRawPublicKey(
      String mnemonic, String coin, String path,
      [String passphrase = ""]) async {
    try {
      final Uint8List publicKey =
          await _channel.invokeMethod('getRawPublicKey', <String, String>{
        'coin': coin,
        'path': path,
        'mnemonic': mnemonic,
        'passphrase': passphrase,
  ...
  /// Returns the hex string format of the private key.
  static Future<Uint8List> getRawPrivateKey(
      String mnemonic, String coin, String path,
      [String passphrase = ""]) async {
    try {
      final Uint8List privateKey =
          await _channel.invokeMethod('getRawPrivateKey', <String, String>{
        'coin': coin,
        'path': path,
        'mnemonic': mnemonic,
        'passphrase': passphrase,
  ...
  static Future<Uint8List> getSeed(String mnemonic, String coin, String path,
      [String passphrase = ""]) async {
    try {
      final Uint8List privateKey =
          await _channel.invokeMethod('getSeed', <String, String>{
        'coin': coin,
        'path': path,
        'mnemonic': mnemonic,
        'passphrase': passphrase,
  ...
  static Future<String> signDataWithPrivateKey(
    ...
    try {
      final String txHash = await _channel
          .invokeMethod('signDataWithPrivateKey', <String, dynamic>{
        'coin': coin,
        'txData': txData,
        'path': path,
        'mnemonic': mnemonic,
